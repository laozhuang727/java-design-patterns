...
import com.ryan.pool2.MyPoolableObjectFactory;
import com.ryan.pool2.Resource;
...
/**
 * @author ryan
 * @version $Id: Test.java, v 0.1 2017年11月11日 下午2:07 ryan Exp $
 */
public class Test {
      ...
      executorService.submit(new Runnable() {
        ...
        public void run() {
          try {
            ...
            System.out.println(Thread.currentThread() + ": " + resource.getRid());

            InetSocketAddress address = new InetSocketAddress("baidu.com", 80);
            Socket socket = resource.getSocket();
